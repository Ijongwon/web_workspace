		...
		<form name="frm1" method="post" action="updateAction.jsp">   <!-- onsubmit="return isValid()" 방법도 있음. -->
			...
			<table>
				...
				<tr>
					...
					<!-- disabled : 입력불가 + 파라미터전송 못함. -->
					</tr>
					<tr>
					 <th>작성날짜</th> <!-- 수정할 값이 아니므로 화면에 표시만 합니다. -->
					 ...
					 <td>
					 	...
					 	<button type="button" onclick="isValid()">저장</button> <!-- 유효성검사 후 자바스크립트에서 submit. hrd_mv2 프로젝트 유효성 검사 참고. -->
...
<script type="text/javascript">
	...
	//그럴 때는 form 태그에 onsubmit="return isValid()"		=> isValid() 를 실행한 리턴이 true 일때만 submit 합니다.
