...
<input type="file" name="picture1" accept=".png,.jpg,.jpeg"><br>
<input type="file" name="picture2" accept="image/png"><br>
<input type="file" name="picture3" accept="image/png"><br>
<input type="file" name="picture4" accept="image/png"><br>
